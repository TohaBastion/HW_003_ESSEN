...
class Shape:
    def __init__(self):
        ...
        self.im = Image.new('RGBA', (501, 501), self.back_color)
...
class Cone(Shape):
    def draw(self):
        self.draw1.chord([(51, 396), (451, 496)], start=0, end=180, fill='yellow', outline=None)
        self.draw1.polygon([(51, 446), (451, 446), (251, 5)], fill='yellow', outline=None)

    def erase(self):
        self.draw1.chord([(51, 396), (451, 496)], start=0, end=180, fill=self.back_color)
        self.draw1.polygon([(51, 446), (451, 446), (251, 5)], fill=self.back_color)
...
class Paraboloid(Shape):
    def draw(self):
        self.draw1.chord([(51, 396), (451, 496)], start=0, end=180, fill='yellow', outline=None)
        self.draw1.chord([(51, 5), (451, 892)], start=180, end=360, fill='yellow', outline=None)

    def erase(self):
        self.draw1.chord([(51, 396), (451, 496)], start=0, end=180, fill=self.back_color)
        self.draw1.chord([(51, 5), (451, 892)], start=180, end=360, fill=self.back_color)
